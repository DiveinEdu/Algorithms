...
@interface CodePopoverController ()

@end

@implementation CodePopoverController
...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    NSFetchedResultsController *aFetchedResultsController = [[NSFetchedResultsController alloc] initWithFetchRequest:fetchRequest managedObjectContext:[DataManager context] sectionNameKeyPath:nil cacheName:@"PopoverController"];
